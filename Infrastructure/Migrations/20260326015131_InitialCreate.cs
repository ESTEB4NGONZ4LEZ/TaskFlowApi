    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StateTaskId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StateTasks", x => x.StateTaskId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "RecordStateTasks",
                columns: table => new
                {
                    RecordStateTaskId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TaskId = table.Column<int>(type: "int", nullable: false),
                    StateTaskId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "GETDATE()"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecordStateTasks", x => x.RecordStateTaskId);
                    table.ForeignKey(
                        name: "FK_RecordStateTasks_StateTasks_StateTaskId",
                        column: x => x.StateTaskId,
                        principalTable: "StateTasks",
                        principalColumn: "StateTaskId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecordStateTasks_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "TaskId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecordStateTasks_Users_ChangedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecordStateTasks_ChangedBy",
                table: "RecordStateTasks",
                column: "ChangedBy");

            migrationBuilder.CreateIndex(
                name: "IX_RecordStateTasks_StateTaskId",
                table: "RecordStateTasks",
                column: "StateTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_RecordStateTasks_TaskId",
                table: "RecordStateTasks",
                column: "TaskId");
